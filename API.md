...
| <code><a href="#cdk-events-notify.EventNotify.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-events-notify.EventNotify.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-events-notify.EventNotify.with.parameter.mixins"></a>
